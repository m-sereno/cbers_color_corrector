...
from .cbers_color_corrector_algorithm import CBERSColorCorrectorAlgorithm


class CBERSColorCorrectorProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(CBERSColorCorrectorAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('CBERS Color Corrector')
